...
//    protected final JHipsterProperties jHipsterProperties;s;
    ...
    protected String getClientSecret() {
        String clientSecret = "paingan-secret";
    ...
    protected String getClientId() {
        String clientId = "paingan-client";
        if (clientId == null) {
    ...
    protected String getTokenEndpoint() {
        String tokenEndpointUrl = "http://paingan-oauth2/oauth/token";
